...
> **Kênh này chỉ tồn tại trong mô phỏng, và nay là hoàn toàn như vậy.**
> [ADR-0001](adr/ADR-0001-sensing-modality.vi.md) đã bị **Bác bỏ ngày 2026-07-10** — thiết bị xuất xưởng chỉ
> dùng camera, nên không có tín hiệu radar nào tới được máy trạng thái thật, và các kịch bản phụ thuộc radar
> bên dưới (SC-06/08/09/25/26, SC-39) chỉ kiểm thử những nhánh mã **đang tạm ngưng trên thiết bị**
> ([tài liệu 04](04-risk-and-safety.vi.md) R20, R21). Mô hình được giữ lại một cách có chủ đích: nó duy trì
> việc kiểm thử thiết kế cấp sở. Quy tắc cứng không đổi — **các sự kiện tổng hợp không bao giờ được tính vào
> recall.**
