...
trình hiệu chuẩn cho từng địa điểm, một lần kiểm tra lại định kỳ, và một **bộ giám sát trôi** trong bộ giám
sát tình trạng, và lỗi này được theo dõi như một rủi ro
...
| Camera chết (CHỈ-RADAR) | **không** — không có lớp / không có hình học ROI trên ảnh | chỉ trong chốc lát, cho các vết đã xác nhận | **MÙ VỚI SỰ CỐ MỚI: cảnh báo trọng yếu** |
...
và một rủi ro được theo dõi ([tài liệu 04 R14](04-risk-and-safety.vi.md#1-bảng-đăng-ký-rủi-ro)).
